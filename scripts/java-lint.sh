...
#   - гоняет ВЕНДОРЕННЫЕ линтеры из .gigacode/vendor/java-linters/:
...
PROJECT_ROOT="$(cd "$SCRIPT_DIR/../.." && pwd)"   # каталог, где лежит .gigacode/
VENDOR="$PROJECT_ROOT/.gigacode/vendor/java-linters"
