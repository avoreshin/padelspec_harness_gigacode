...
# =============================================================================
# configure-macos.sh — настройка окружения для работы с SberOSC,
# Confluence (Sigma + Delta) и Jira Delta на macOS.
#
...
echo "============================================="
echo " MCP Atlassian Setup — macOS"
echo "============================================="
echo ""
...
if [[ ! -d "${HOME}/.venv" ]]; then
    ...
    echo "    Venv создан: ${HOME}/.venv"
else
    echo "    Venv уже существует: ${HOME}/.venv"
fi

# Устанавливаем пакеты в активированном venv
"${HOME}/.venv/bin/python3" -m pip install requests mcp-atlassian==0.21.0 redis==7.2.1 \
