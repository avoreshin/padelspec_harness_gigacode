...
[![version](https://img.shields.io/badge/version-v0.6.10-blue?style=flat-square)](https://github.com/avoreshin/padelspec_harness_gigacode/releases)
...
> Версия сборки: **0.6.10** · источник: `abe5e12`
...
**Обновление:** `git pull` в каталоге расширения + переустановить тем же `/extensions install <путь>`.
