...
[![version](https://img.shields.io/badge/version-v0.10.0-blue?style=flat-square)](https://github.com/avoreshin/padelspec_harness_gigacode/releases)
...
> Версия сборки: **0.10.0** · источник: `b284abb`
...
| `/pdls:review-autotests <release>` | ревью сгенерированных сценариев против тест-модели: канал проверки, полярность ожидания, именованные объекты, покрытие шагов. Read-only, правок не вносит |
